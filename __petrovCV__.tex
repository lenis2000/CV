...
Undergraduate Math Club co-organizer.
...
\begin{itemize}
	\item
	Member of the editorial boards at ``\href{https://escholarship.org/uc/combinatorial_theory/}{\textbf{Combinatorial Theory}}'' and ``\href{https://imstat.org/journals-and-publications/electronic-journal-of-probability/}{\textbf{Electronic Journal/Communications of Probability}}''.
	...
	grant panelist for NSF and international funding agencies.
\end{itemize}
...
\begin{itemize}
  ...
  \item
  Advancing digital accessibility of mathematical content in compliance with WCAG 2.1 Level AA standards:
