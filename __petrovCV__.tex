...
\begin{etaremune}
	% \item 
	% Conference ``Mathematics is a long conversation: a celebration of Barry Mazur'', June 2018, Harvard University, Cambridge, MA, USA.
	%
	% \item 
	% 	Conference ``Representation Theory, Geometry, and Quantization:
	% 	Bertram Kostant
