...
\begin{etaremune}
	...
	\item
		...
		arXiv:1912.08671 [math.PR]. Journal of Statistical Physics, to appear.
	\item ($*$)
...
\begin{longtable}{llc}
	2020, December
	& Representation Theory and Mathematical Physics Seminar at Kansas State University (online)
	\\\\
	2020, October
...
\begin{itemize}
	\item
	Member of the editorial board at ``Mathematical Physics, Analysis and Geometry'' (\url{https://www.springer.com/journal/11040}) and ``Combinatorial Theory'' (\url{http://math.sfsu.edu/beck/ct/}).
	\item 
