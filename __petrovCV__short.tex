...
\begin{itemize}
	\item
	Member of the editorial boards at ``Mathematical Physics, Analysis and Geometry'' (\url{https://www.springer.com/journal/11040}), ``Combinatorial Theory'' (\url{https://escholarship.org/uc/combinatorial_theory/}), and ``Electronic Journal/Communications of Probability'' (\url{https://imstat.org/journals-and-publications/electronic-journal-of-probability/}).
